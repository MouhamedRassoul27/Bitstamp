...
{
    /// <summary>
    /// A custom JSON converter for the Bitstamp <see cref="BitstampCandle"/> class
    /// </summary>
    public class BitstampCandlesConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            return objectType == typeof(BitstampCandle);
        }
    }
}