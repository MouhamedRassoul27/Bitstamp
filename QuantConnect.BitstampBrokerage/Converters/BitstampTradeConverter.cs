...
{
    /// <summary>
    /// A custom JSON converter for the Bitstamp <see cref="BitstampTrade"/> class
    /// </summary>
    public class BitstampTradeConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            return objectType == typeof(BitstampTrade);
        }
    }
}