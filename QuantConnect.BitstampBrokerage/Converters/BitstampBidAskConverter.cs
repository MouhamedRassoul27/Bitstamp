...
namespace QuantConnect.Brokerages.Bitstamp.Converters
{
    /// <summary>
    /// A custom JSON converter for the Bitstamp <see cref="BitstampBidAsk"/> class
    /// </summary>
    public class BitstampBidAskConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            return objectType == typeof(BitstampBidAsk);
        }
    }
}