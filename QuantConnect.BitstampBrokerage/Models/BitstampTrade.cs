...
using QuantConnect.Brokerages.Bitstamp.Converters;

namespace QuantConnect.Brokerages.Bitstamp.Models
{
    /// <summary>
    /// Bitstamp ws trade https://docs.Bitstamp.com/websockets/#message-trade
    /// </summary>
    [JsonConverter(typeof(BitstampTradeConverter))]
