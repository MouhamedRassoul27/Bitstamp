...
{
    public class BitstampExchangeInfoDownloader : IExchangeInfoDownloader
    {
        public string Market => QuantConnect.Market.Bitstamp;
        public IEnumerable<string> Get()
        {
            const string url = "https://api.Bitstamp.com/0/public/AssetPairs";
            ...
            foreach (JProperty instr in t["result"].Children())
            {
                ...
                yield return $"Bitstamp,{instr.Value["altname"]},crypto,{instr.Value["wsname"]},{quote},{instr.Value["lot_multiplier"]},{priceDecimals},{quantityDecimals},{instr.Name},{instr.Value["ordermin"]}";
            }
        }
    }
}
