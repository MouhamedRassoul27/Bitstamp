...
using QuantConnect.ToolBox.BitstampDataDownloader;
    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            if (targetApp.Contains("download") || targetApp.EndsWith("dl"))
            {
                ...
                {
                    case "kdl":
                    case "Bitstampdownloader":
                        BitstampDownloaderProgram.BitstampDownloader(tickers, resolution, fromDate, toDate);
                        break;
            ...
            else if (targetApp.Contains("updater") || targetApp.EndsWith("spu"))
            {
                ...
                {
                    case "kspu":
                    case "Bitstampsymbolpropertiesupdater":
                        BitstampDownloaderProgram.ExchangeInfoDownloader();
                        break;
                    default:
                        PrintMessageAndExit(1, "ERROR: Unrecognized --app value");
                        break;
