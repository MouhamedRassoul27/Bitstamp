    ...
    public partial class BitstampBrokerageTests
    {
        private static TestCaseData[] TestParameters
        {
            get
            {
                return new[]
                {
                    new TestCaseData(Symbol.Create("EURUSD", SecurityType.Crypto, Market.Bitstamp), Resolution.Tick, 10000, false),
                    new TestCaseData(Symbol.Create("BTCUSD", SecurityType.Crypto, Market.Bitstamp), Resolution.Tick, 10000, false),
                    new TestCaseData(Symbol.Create("BTCUSD", SecurityType.Crypto, Market.Bitstamp), Resolution.Second, 10000, false),
                    new TestCaseData(Symbol.Create("BTCUSD", SecurityType.Crypto, Market.Bitstamp), Resolution.Minute, 60000, false),
                };
            }
        }
