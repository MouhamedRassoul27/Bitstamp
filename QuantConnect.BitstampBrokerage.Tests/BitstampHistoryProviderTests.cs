...
{
    public partial class BitstampBrokerageTests
    {
        [Test]
        ...
        private static TestCaseData[] ValidHistory
        {
            get
            {
                ...
                {
                    // valid
                    new TestCaseData(Symbol.Create("ETHUSD", SecurityType.Crypto, Market.Bitstamp), Resolution.Tick, Time.OneHour, false),
                    new TestCaseData(Symbol.Create("ETHUSD", SecurityType.Crypto, Market.Bitstamp), Resolution.Minute, Time.OneDay, false),
                    new TestCaseData(Symbol.Create("ETHUSD", SecurityType.Crypto, Market.Bitstamp), Resolution.Hour, TimeSpan.FromDays(30), false),
                    new TestCaseData(Symbol.Create("ETHUSD", SecurityType.Crypto, Market.Bitstamp), Resolution.Daily, TimeSpan.FromDays(15), false),
                };
            }
        }
        ...
        private static TestCaseData[] NoHistory
        {
            get
            {
                return new[]
                {
                    new TestCaseData(Symbol.Create("ETHUSD", SecurityType.Crypto, Market.Bitstamp), Resolution.Second, Time.OneMinute),
        ...
        private static TestCaseData[] InvalidHistory
        {
            get
            {
                return new[]
                {
                    ...
                    new TestCaseData(Symbol.Create("XYZ", SecurityType.Crypto, Market.Bitstamp), Resolution.Daily, TimeSpan.FromDays(15), true)
                };
            }
        }
    }
