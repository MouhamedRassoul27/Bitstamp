...
{
    public class BitstampRateLimitsTests
    {
        [Test]
        ...
        public void RestRateLimitTest(string tier, int requestNumber, bool shouldExceed)
        {
            ...
            var rateLimiter = new TestBitstampBrokerageRateLimits(tier);
        ...
        private class TestBitstampBrokerageRateLimits : BitstampBrokerageRateLimits
        {
            public decimal GetRateLimitCounter => RateLimitCounter;
            public TestBitstampBrokerageRateLimits(string verificationTier) : base(verificationTier, 100)
            {
            }
